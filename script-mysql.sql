...
CREATE TABLE IF NOT EXISTS `schooldb`.`tb_person` (
  ...
  INDEX `FK_PERSON_LOGIN_idx` (`loginId` ASC) VISIBLE,
  CONSTRAINT `FK_PERSON_LOGIN`
    FOREIGN KEY (`loginId`)
    REFERENCES `schooldb`.`tb_login` (`loginId`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_bin;
...
CREATE TABLE IF NOT EXISTS `schooldb`.`tb_gradebook` (
  ...
  `Q1` DECIMAL(3,2) NULL DEFAULT NULL,
  `Q2` DECIMAL(3,2) NULL DEFAULT NULL,
  `Q3` DECIMAL(3,2) NULL DEFAULT NULL,
