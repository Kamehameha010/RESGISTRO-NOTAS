...
namespace SchoolSystem.Infrastructure.Migrations
{
    ...
    [Migration("20211029185421_Initials")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolSystem.Infrastructure.Course", b =>
                {
            ...
            modelBuilder.Entity("SchoolSystem.Infrastructure.CourseGradebook", b =>
                {
            ...
            modelBuilder.Entity("SchoolSystem.Infrastructure.CourseStatus", b =>
                {
                    b.Property<int>("CourseStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("coursestatusid")
            ...
            modelBuilder.Entity("SchoolSystem.Infrastructure.Rol", b =>
                {
            ...
            modelBuilder.Entity("SchoolSystem.Infrastructure.Student", b =>
                {
                    b.Property<int>("StudentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("studentid")
            ...
            modelBuilder.Entity("SchoolSystem.Infrastructure.Teacher", b =>
                {
                    b.Property<int>("TeacherId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("teacherid")
            ...
            modelBuilder.Entity("SchoolSystem.Infrastructure.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("userid")
            ...
            modelBuilder.Entity("SchoolSystem.Infrastructure.Course", b =>
                {
                    b.HasOne("SchoolSystem.Infrastructure.CourseStatus", "CourseStatus")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("SchoolSystem.Infrastructure.CourseGradebook", b =>
                {
                    b.HasOne("SchoolSystem.Infrastructure.Course", "Course")
                        .WithMany("CourseGradebooks")
                        .HasForeignKey("CourseId")
                        .HasConstraintName("tb_course_gradebook_courseid_fkey");

                    b.HasOne("SchoolSystem.Infrastructure.Student", "Student")
                        .WithMany("CourseGradebooks")
                        .HasForeignKey("StudentId")
                        .HasConstraintName("tb_course_gradebook_studentid_fkey");

                    b.HasOne("SchoolSystem.Infrastructure.Teacher", "Teacher")
                        .WithMany("CourseGradebooks")
            ...
            modelBuilder.Entity("SchoolSystem.Infrastructure.Student", b =>
                {
                    b.HasOne("SchoolSystem.Infrastructure.User", "User")
                        .WithMany("Students")
            ...
            modelBuilder.Entity("SchoolSystem.Infrastructure.User", b =>
                {
                    b.HasOne("SchoolSystem.Infrastructure.Rol", "Rol")
                        .WithMany("Users")
                        .HasForeignKey("RolId")
